            ...
            >
              ...
              >
                ...
                <div className="mb-6 p-4 bg-slate-50 rounded-lg">
                  <p className="text-sm text-slate-600"><strong>De:</strong> {viewingContact.fullName || viewingContact.name} ({viewingContact.email})</p>
                  {viewingContact.phone && (
                    <p className="text-sm text-slate-600"><strong>Tel:</strong> {viewingContact.phone}</p>
                  )}
